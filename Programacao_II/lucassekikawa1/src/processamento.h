...
/* Caso nao haja -w na entrada do programa, essa sera a funcao chamada, ela é a estrutura principal
   do caso de calculo do rendimento final. 
   Recebe o vetor de arquivos, seu tamanho, os anos de inicio e fim, e o capital inicial
